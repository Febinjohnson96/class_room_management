...
import 'package:class_room_management/presentation/registration/registration_screen_ui.dart';
import 'package:class_room_management/presentation/student/student_screen_ui.dart';
...
final GoRouter appRoute = GoRouter(
  routes: [
    ...
    GoRoute(
        ...
        builder: (context, state) => const RegistrationScreenUi()),
    GoRoute(
        path: RouteName.student,
        builder: (context, state) => const StudentScreenUi()),
    GoRoute(
